...
mysqli_data_seek($category_result, 0); // Reset pointer for later use
                            ...
                            <?php if(mysqli_num_rows($result) > 0): ?>
                                <?php while($item = mysqli_fetch_assoc($result)): ?>
                                    <tr class="<?php echo $item['is_available'] ? 'available' : 'unavailable'; ?>">
                                        ...
                                        <td class="actions">
                                            <button onclick="editMenuItem(<?php echo $item['item_id']; ?>)" class="edit-btn">Edit</button>
                                            <button onclick="deleteMenuItem(<?php echo $item['item_id']; ?>)" class="delete-btn">Delete</button>
                                        </td>
                                    </tr>
                                <?php endwhile; ?>
                            <?php else: ?>
