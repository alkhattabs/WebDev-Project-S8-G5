                            ...
                            <tbody>
                                <?php foreach($orders as $order): ?>
                                    <tr data-order-id="<?php echo $order['order_id']; ?>">
                                        ...
                                        <td>
                                            <button onclick="viewItems(<?php echo $order['order_id']; ?>)" class="view-items-btn">
                                                View Items
                                            </button>
                                        </td>
                                        ...
                                        <td class="actions">
                                            <button type="button" onclick="editOrder(<?php echo $order['order_id']; ?>)" class="edit-btn">Edit</button>
                                            <button onclick="viewReceipt(<?php echo $order['order_id']; ?>)" class="receipt-btn">Receipt</button>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
