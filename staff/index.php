                        ...
                        <tbody>
                            <?php foreach($staff as $member): ?>
                                <tr>
                                    ...
                                    <td class="actions">
                                        <button onclick="editStaff(<?php echo $member['staff_id']; ?>)" class="edit-btn">Edit</button>
                                        <button onclick="deleteStaff(<?php echo $member['staff_id']; ?>)" class="delete-btn">Delete</button>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
