                        ...
                        <tbody>
                            <?php foreach ($customers as $customer): ?>
                                <tr data-id="<?php echo $customer['customer_id']; ?>">
                                    ...
                                    <td class="actions">
                                        <button class="edit-btn btn-action" onclick="editCustomer(<?php echo $customer['customer_id']; ?>)">Edit</button>
                                        <button class="delete-btn btn-action" onclick="deleteCustomer(<?php echo $customer['customer_id']; ?>)">Delete</button>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
